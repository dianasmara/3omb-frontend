...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      'OOGIE-WFTM LP': ['0x83A52eff2E9D112E9B022399A9fD22a9DB7d33Ae',18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  //   name: 'Earn OOGIE by staking 2OMB-2SHARES LP',
  //   poolId: 2,
  //   sectionInUI: 0,
  ...
  //   name: 'Earn OOGIE by staking 2OMB-WFTM LP',
  //   poolId: 2,
  //   sectionInUI: 0,
  ...
  // },
  // Tomb2ombRewardPool: {
  //   name: 'Earn OOGIE by staking 2OMB',
  //   poolId: 3,
  //   sectionInUI: 0,
  ...
  //   name: 'Earn OOGIE by staking BELUGA',
  //   poolId: 4,
  //   sectionInUI: 0,
  ...
  // },
  // TombBifiRewardPool: {
  //   name: 'Earn OOGIE by staking BIFI',
  //   poolId: 5,
  //   sectionInUI: 0,
  ...
  //   name: 'Earn OOGIE by staking WFTM',
  //   poolId: 6,
  //   sectionInUI: 0,
  ...
  // },
  // TombMimRewardPool: {
  //   name: 'Earn OOGIE by staking MIM',
  //   poolId: 7,
  //   sectionInUI: 0,
  ...
  // },
  // TombBloomRewardPool: {
  //   name: 'Earn OOGIE by staking BLOOM',
  //   poolId: 8,
  //   sectionInUI: 0,
  ...
  TombFtmLPTShareRewardPool: {
    name: 'Stake OOGIE-wFTM |4| 3SHARES',
    poolId: 0,
    sectionInUI: 2,
    contract: 'TombFtmLPTShareRewardPool',
    depositTokenName: 'OOGIE-WFTM LP',
  ...
  TshareFtmLPTShareRewardPool: {
    name: 'Stake 3SHARES-wFTM |4| 3SHARES',
    poolId: 2,
    sectionInUI: 2,
  ...
  //   name: 'Stake 2SHARES-wFTM |4| 3SHARES',
  //   poolId: 2,
  //   sectionInUI: 2,
  ...
  TwoombFtmLPTShareRewardPool: {
    name: 'Stake 2OMB-wFTM |4| 3SHARES',
    poolId: 3,
    sectionInUI: 3,
    contract: 'TwoshareFtmLPTShareRewardPool',
    depositTokenName: '2OMB-WFTM LP',
  ...
  TwoombTwosharesLPTShareRewardPool: {
    name: 'NEW OPTION COMING SOON!!! ***Stake OOGIE-3SHARES |4| 3SHARES***',
    poolId: 4,
    sectionInUI: 2,
  ...
  //Tomb3SHARESFTMRebates: {
   // name: 'Bond 3SHARES-WFTM LP, earn OOGIE',
   // poolId: 5,
   // sectionInUI: 3,
  //  contract: 'TombFtmRewardPool',
  //  depositTokenName: '3SHARES-WFTM LP',
