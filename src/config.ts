...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      'BOO-WFTM LP': ['0x83A52eff2E9D112E9B022399A9fD22a9DB7d33Ae',18],
      'BSHARES-WFTM LP': ['0xd352daC95a91AfeFb112DBBB3463ccfA5EC15b65',18],
      'BSHARES': ['0x6437ADAC543583C4b31Bf0323A0870430F5CC2e7', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  sectionInUI: way to distinguish in which of the 3 pool groups it should be listed
        ...
        - 1 = LP asset staking rewarding 2omb
        - 2 = LP asset staking rewarding 2share
  ...
  */
  ...
  //   name: 'Earn BOO by staking 2OMB-2SHARES LP',
  //   poolId: 2,
  //   sectionInUI: 0,
  ...
  //   name: 'Earn BOO by staking 2OMB-WFTM LP',
  //   poolId: 2,
  //   sectionInUI: 0,
  ...
  //   name: 'Earn BOO by staking BELUGA',
  //   poolId: 4,
  //   sectionInUI: 0,
  ...
  // },
  // TombBloomRewardPool: {
  //   name: 'Earn BOO by staking BLOOM',
  //   poolId: 8,
  //   sectionInUI: 0,
  ...
  TombFtmLPTShareRewardPool: {
    name: 'Stake DICE-wFTM |4| DSHARES',
    poolId: 0,
    sectionInUI: 2,
    contract: 'TombFtmLPTShareRewardPool',
    depositTokenName: 'DICE-WFTM LP',
  ...
  TshareFtmLPTShareRewardPool: {
    name: 'Stake DSHARES-wFTM |4| DSHARES',
    poolId: 2,
    sectionInUI: 2,
  ...
  //   name: 'Stake 2SHARES-wFTM |4| BSHARES',
  //   poolId: 2,
  //   sectionInUI: 2,
  //   contract: 'TwoshareFtmLPTShareRewardPool',
  //   depositTokenName: '2SHARES-WFTM LP',
  //   earnTokenName: 'BSHARES',
  //   finished: false,
  //   buyLink: 'https://spookyswap.finance/add/FTM/0xc54A1684fD1bef1f077a336E6be4Bd9a3096a6Ca',
  //   site: 'https://2omb.finance',
  //   sort: 10,
  ...
  TwoombFtmLPTShareRewardPool: {
    name: 'Stake 2OMB-wFTM |4| BSHARES',
    poolId: 3,
    sectionInUI: 3,
    contract: 'TwoshareFtmLPTShareRewardPool',
    depositTokenName: '2OMB-WFTM LP',
  ...
  TwoombTwosharesLPTShareRewardPool: {
    name: 'NEW OPTION COMING SOON!!! ***Stake BOO-BSHARES |4| BSHARES***',
    poolId: 4,
    sectionInUI: 2,
  ...
  Tomb3OMBFTMRebates: {
    name: 'NEW COMING SOON ***Trade USDC***',
    poolId: 3,
    sectionInUI: 3,
    contract: 'TombFtmRewardPool',
    depositTokenName: 'BOO-WFTM LP',
    earnTokenName: 'BOO',
    finished: true,
    buyLink: '',
    site: '',
  ...
  // Tomb3SHARESRebates: {
  //   name: 'Bond BSHARES, earn BOO',
  //   poolId: 4,
  //   sectionInUI: 3,
  //   contract: 'TombFtmRewardPool',
  //   depositTokenName: 'BSHARES',
  //   earnTokenName: 'BOO',
  //   finished: false,
  //   buyLink: '',
  //   site: '',
  ...
  //Tomb3SHARESFTMRebates: {
   // name: 'Bond BSHARES-WFTM LP, earn BOO',
   // poolId: 5,
   // sectionInUI: 3,
  //  contract: 'TombFtmRewardPool',
  //  depositTokenName: 'BSHARES-WFTM LP',
  //  earnTokenName: 'BOO',
  //  finished: false,
  //  buyLink: '',
 //   site: '',
